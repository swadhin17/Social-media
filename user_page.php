...
//      echo $post_content , $file_name , $name;
...
-->
      ...
      <form class="navbar-form navbar-left">
        <div class="form-group">
          <input type="text" class="form-control " id=t1 placeholder="Search...">
        </div>
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li><a href="#" id=l5 > Followers<span class="badge " id=badge >0</span> </a></li>
        <li class="dropdown" id=d2 >
          <a href="#" class="dropdown-toggle" id=dl2 data-toggle="dropdown"> Hi Savan <span class="caret"></span></a>    
