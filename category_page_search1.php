...
<!--        <span class="sr-only">Toggle navigation</span>-->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
       <li><a href="blog/index.php" id=l2 > Home </a></li>
<!--
...
-->
      ...
      <form action="category_page_search1.php" method="post" class="navbar-form navbar-left">
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li><a href="login.php" id=l2 > Login In / Sign Up </a></li>
...
//          echo $search;
          ...
          $query = "SELECT * FROM blog_posts WHERE category LIKE '%$id_name%'";
