...
<div class=" col-xl-4 ">
       ...
       <div class="card" id="card_id">
      <img class="card-img-top" src="images/emp1.jpg" alt="Card image cap">
      <div class="card-body">
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur laudantium doloremque eius quo iure, blanditiis ratione ex voluptatum dolores dolore eum dignissimos nobis voluptas cupiditate libero expedita laboriosam quae, quaerat.</p>
      ...
      <button type="submit" class="btn btn-outline-secondary mb-2 " id="comment-button-id">submit</button>
    </form>
